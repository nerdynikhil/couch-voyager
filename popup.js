...
// Function to auto-click the center of the page
function clickCenterOfPage() {
  var body = document.body; // Target the body or the main container element
  ...
  body.dispatchEvent(event); // Simulate the click event
}

// Set an interval to auto-click the center of the page every 5 seconds
setInterval(clickCenterOfPage, 5000);
